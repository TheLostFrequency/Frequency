      ...
      tracks
        .map(
          (track, index) => `
            ...
            >
              <span class="album-card" aria-hidden="true">
                ...
                <span class="album-edge album-edge-right"></span>
                <span class="album-edge album-edge-bottom"></span>
              </span>
            </button>
          `
        )
...
function updateCarouselPosition() {
  ...
  cards.forEach(
    (card, index) => {
      ...
      /*
        The center cover is physically closest to the
        viewer. Cards beside it are rotated and pushed
        backward on the Z axis. Farther cards fade away
        rather than forming a flat row.
      */
